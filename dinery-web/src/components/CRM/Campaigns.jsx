  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-100 flex items-start justify-between gap-3">
        ...
        <button onClick={() => onEdit(campaign)} className="text-xs font-semibold text-gray-500 hover:text-[#fe8a24] transition-colors px-2 py-1 rounded-md hover:bg-orange-50">
          {t('Edit')}
        </button>
        <button onClick={() => onDelete(campaign.id)} className="text-xs font-semibold text-gray-500 hover:text-red-500 transition-colors px-2 py-1 rounded-md hover:bg-red-50">
          {t('Delete')}
        </button>
      </div>
      </div>
